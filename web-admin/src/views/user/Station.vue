...
import {saveStation, deleteStation, listStation} from '@/api/user/station.js'
...
const rules = {
  ...
  namePinyin: [
    {required: false, message: '请输入车站名的拼音', trigger: 'blur'},
  ],
  namePy: [
    {required: false, message: '请输入车站名的拼音的首字母缩写', trigger: 'blur'},
  ],
  description: [
    {required: false, message: '请输入车站描述', trigger: 'blur'},
  ],
}
...
<template>
  <div class="station-container">
    ...
    >
      ...
      <el-table-column prop="namePinyin" label="车站名的拼音"/>
      <el-table-column prop="namePy" label="车站名的拼音的首字母缩写"/>
      <el-table-column prop="description" label="车站描述"/>
    ...
    >
      <el-form
        ...
        status-icon
      >
        <el-form-item label="车站名" prop="name">
          <el-input
        ...
        <el-form-item label="车站名的拼音" prop="namePinyin">
          <el-input
            v-model="stationForm.namePinyin"
            placeholder="请输入车站名的拼音"
            clearable
          />
        </el-form-item>
        <el-form-item label="车站名的拼音的首字母缩写" prop="namePy">
          <el-input
            v-model="stationForm.namePy"
            placeholder="请输入车站名的拼音的首字母缩写"
            clearable
          />
        </el-form-item>
        <el-form-item label="车站描述" prop="description">
          <el-input
